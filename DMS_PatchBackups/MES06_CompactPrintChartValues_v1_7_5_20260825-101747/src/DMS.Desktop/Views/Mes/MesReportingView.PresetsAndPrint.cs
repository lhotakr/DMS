...
public partial class MesReportingView
{
        ...
        FlowDocument document)
    {
        ...
        try
        {
            // The on-screen chart is intentionally compact (220 DIP).
            // Scaling that bitmap in the print document does NOT give the
            // chart engine room to draw axis/category labels.
            //
            // Temporarily perform a real WPF layout at a taller size so the
            // chart itself recalculates bars, axes and text before capture.
            ChartBorder.Height =
                470d;
        ...
        {
            // Preview/PDF must remain usable even if a specific chart
            // implementation cannot be re-laid out on a workstation.
            _logger.Error(
