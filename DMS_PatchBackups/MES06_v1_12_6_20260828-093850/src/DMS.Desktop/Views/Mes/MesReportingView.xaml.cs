    ...
    : UserControl
{
    ...
    private async Task LoadCurrentReportAsync()
    {
        ...
        // MES06 always follows FASTEC "Related to: Start of shift" semantics.
        //
        // Example for the current 05:55 / 13:55 / 21:55 configuration:
        //   UI dates: 24.08 -> 25.08
        //   effective range: 24.08 05:55 -> 25.08 05:55
        //
        // The actual first-shift start is resolved from ana.DimShiftEvent.
        var from =
            selectedFromDate;
